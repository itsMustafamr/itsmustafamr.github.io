...
permalink: /publication/2025-11-06-trustworthy-llm-mediated-communication
...
date: 2025-11-06
venue: 'IEEE DISTILL 2025 (co-located with IEEE TPS 2025)'
paperurl: 'https://arxiv.org/abs/2511.04184'
arxiv: '2511.04184'
citation: 'Mohammed Musthafa Rafi, Adarsh Krishnamurthy, Aditya Balu. (2025). &quot;Trustworthy LLM-Mediated Communication: Evaluating Information Fidelity in LLM as a Communicator (LAAC) Framework in Multiple Application Domains.&quot; <i>IEEE DISTILL 2025</i> (co-located with IEEE TPS 2025). arXiv:2511.04184.'
---

The proliferation of AI-generated content has created an absurd communication theater where senders use LLMs to inflate simple ideas into verbose content, recipients use LLMs to compress them back into summaries, and as a consequence neither party engage with authentic content. LAAC (LLM as a Communicator) proposes a paradigm shift - positioning LLMs as intelligent communication intermediaries that capture the sender's intent through structured dialogue and facilitate genuine knowledge exchange with recipients. Rather than perpetuating cycles of AI-generated inflation and compression, LAAC enables authentic communication across diverse contexts including academic papers, proposals, professional emails, and cross-platform content generation.
...
**Keywords:** Large Language Models, LLM as a Communicator, Information Fidelity, Trustworthy AI, Human-AI Interaction, Communication Systems
